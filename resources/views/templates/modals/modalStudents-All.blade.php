...
<!--Modal para asignar puntaje a los alumnos-->
<div class="modal fade" id="modalFormAlumnoPoints" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Asignar Puntaje al Alumno</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formAlumnsPoints" name="formAlumnsPoints" class="form-horizontal">
                    <input type="hidden" id="idAlumnPoint" name="idAlumnPoint" value="">
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <p><strong>Rut:</strong>&nbsp;&nbsp;<span id="rutAlumPoint"></span></p>
                                <p><strong>Nombres:</strong>&nbsp;&nbsp;<span id="nombreAlumPoint"></span></p>
                                <p><strong>Email:</strong>&nbsp;&nbsp;<span id="emailAlumPoint"></span></p>
                            </div>
                        </div>
